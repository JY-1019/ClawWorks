...
export const th: TranslationMap = {
  ...
  enterprise: {
    ...
    toolsTab: {
      ...
      attachHintGranted:
        "แผนงานนี้กำหนดเครื่องมือไว้อย่างชัดเจน แต่ละขั้นตอนสามารถเรียกใช้ได้เฉพาะเครื่องมือที่ระบุไว้ในขั้นตอนนั้น หรือเครื่องมือที่ระบุไว้ในขั้นตอนที่อยู่เหนือขึ้นไปเท่านั้น เครื่องมืออื่นทั้งหมดในแค็ตตาล็อกนี้จะถูกปฏิเสธ",
    ...
    entryDraft: {
      ...
      scopeUngranted:
        "แผนงานนี้กำหนดเครื่องมือแบบระบุชัดเจน ขั้นตอนนี้จะไม่สามารถเข้าถึงเครื่องมือใดได้จนกว่าจะมีการระบุไว้ที่นี่หรือในขั้นตอนด้านบน",
      knowledgeNarrowing:
      ...
      ancestorGate:
        "ขั้นตอนหลัก ({nodeIds}) มีรายการอนุญาตของตัวเองสำหรับสิ่งนี้ การตรวจสอบ Governance จะตรวจสอบแต่ละขั้นตอนจากรูท ดังนั้นรายการที่เพิ่มที่นี่จะยังคงถูกปฏิเสธ เว้นแต่ขั้นตอนเหล่านั้นจะอนุญาตด้วย",
    ...
    capabilityGrants: {
      ...
      explicitHint:
        "แต่ละขั้นตอนสามารถเข้าถึงได้เฉพาะเครื่องมือ, Skills, MCP servers และฐานความรู้ที่ระบุไว้ในขั้นตอนนั้นหรือขั้นตอนที่อยู่เหนือขึ้นไปเท่านั้น หากขั้นตอนใดไม่ได้ระบุไว้เลย จะไม่สามารถเข้าถึงสิ่งใดได้",
      inheritedHint:
