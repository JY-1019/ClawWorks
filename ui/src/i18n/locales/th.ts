...
export const th: TranslationMap = {
  ...
  enterprise: {
    ...
    capabilityGrants: {
      ...
      explicitHint:
        "แต่ละขั้นตอนจะเข้าถึงได้เฉพาะเครื่องมือ, Skills และ MCP servers ที่ระบุไว้ในขั้นตอนนั้นหรือขั้นตอนที่อยู่เหนือขึ้นไปเท่านั้น ขั้นตอนที่ไม่ได้ระบุสิ่งใดไว้จะไม่สามารถเข้าถึงสิ่งใดได้เลย",
      inheritedHint:
