...
export const th: TranslationMap = {
  ...
  enterprise: {
    ...
    toolsTab: {
      title: "เครื่องมือ",
      subtitle:
        "แค็ตตาล็อกเครื่องมือที่กำหนดค่าไว้ จัดกลุ่มตามวิธีที่รันไทม์จัดกลุ่ม เครื่องมือปลั๊กอินจะแสดงรายการทันทีที่ประกาศ แม้ก่อนที่การกำหนดค่าจะเสร็จสมบูรณ์ และเครื่องมือ channel กับ MCP จะมีอยู่เฉพาะในเซสชันที่กำลังทำงานเท่านั้น ดังนั้นนี่คือสิ่งที่สามารถกำหนดค่าได้ ไม่ใช่สิ่งที่กำลังทำงานอยู่ในขณะนี้",
      attachHint:
        "นี่คือแค็ตตาล็อก หากต้องการให้ขั้นตอนเรียกใช้เครื่องมือ ให้เปิด Worktree เลือกขั้นตอน แล้วเพิ่มภายใต้ Step bindings",
      attachHintGrantedGated:
        "แผนงานนี้กำหนดเครื่องมือที่อนุญาตไว้อย่างชัดเจน แต่ละขั้นตอนควรใช้เครื่องมือที่ระบุไว้ในขั้นตอนนั้น หรือที่ระบุไว้ในขั้นตอนระดับบน สิ่งอื่นนอกเหนือจากนี้จะต้องขออนุมัติเป็นรายครั้งแทนที่จะทำงานทันที และจะถูกปฏิเสธหากไม่มีผู้ตอบ การตอบกลับและการอ่าน (message, read, memory_search) ยังคงใช้งานได้ในทุกขั้นตอน เว้นแต่ขั้นตอนนั้นจะปฏิเสธหรือนโยบายการกำกับดูแลจะปฏิเสธ",
      empty: "ไม่มีเครื่องมือที่พร้อมใช้งานบน Gateway นี้",
      toolCount: "{count} เครื่องมือ",
      optionalBadge: "ไม่บังคับ",
      pluginBadge: "ปลั๊กอิน: {pluginId}",
    },
    mcpTab: {
      title: "MCP",
      subtitle:
        "เซิร์ฟเวอร์ MCP ที่ลงทะเบียนสำหรับ gateway นี้ การลงทะเบียนที่นี่เหมือนกับที่อื่นใน OpenClaw — จะถูกบันทึกใน mcp.servers — แต่ภายใต้การกำกับดูแลระดับองค์กร เซิร์ฟเวอร์จะไม่สามารถเข้าถึงได้จนกว่าจะมีขั้นตอนแนบเซิร์ฟเวอร์นั้น",
      attachHint:
        "หากต้องการให้ขั้นตอนเรียกใช้เซิร์ฟเวอร์ ให้เปิด Worktree เลือกขั้นตอน แล้วเพิ่มภายใต้ Step bindings เซิร์ฟเวอร์ที่ไม่มีขั้นตอนใดแนบจะถูกลงทะเบียนไว้แต่ไม่สามารถเข้าถึงได้",
      nativeConfigBoundary:
        "การตั้งค่านี้ควบคุมเซิร์ฟเวอร์ที่ OpenClaw ส่งมอบให้กับการรัน เซิร์ฟเวอร์ที่ประกาศโดยตรงในการกำหนดค่าของ harness เอง เช่น ไฟล์ Codex config จะอยู่นอกขอบเขตนี้ — เลเยอร์นั้นเป็นของ harness ไม่ใช่ของ Gateway",
      attachHintUngoverned:
        "Work-map นี้ยังไม่ได้ควบคุม MCP ดังนั้นเซิร์ฟเวอร์ที่ลงทะเบียนไว้จะยังคงเรียกใช้ได้ในฐานะเครื่องมือทั่วไป การแนบเซิร์ฟเวอร์เข้ากับขั้นตอนภายใต้ Step bindings จะเปิดใช้งาน deny-by-default สำหรับ work-map ทั้งหมด",
      empty: "ไม่มีเซิร์ฟเวอร์ MCP ที่ลงทะเบียนสำหรับ Gateway นี้",
      add: "ลงทะเบียนเซิร์ฟเวอร์",
      disabled: "ปิดใช้งาน",
      unattached: "ไม่ได้แนบกับขั้นตอนใด",
      unsaved: "การลงทะเบียนนี้อยู่ในเบราว์เซอร์ของคุณเท่านั้นจนกว่าคุณจะบันทึกลงในการตั้งค่า",
      waitingForConfig: "กำลังโหลดการกำหนดค่า Gateway อยู่ การลงทะเบียนจะพร้อมใช้งานเมื่อโหลดเสร็จแล้ว",
      configSaving:
        "กำลังบันทึกการตั้งค่าอยู่ กรุณารอให้เสร็จสิ้น — เซิร์ฟเวอร์ที่ลงทะเบียนตอนนี้จะถูกละทิ้งเมื่อการตั้งค่าที่บันทึกถูกโหลดใหม่",
      configInvalid:
        "การตั้งค่า Gateway ไม่สามารถแยกวิเคราะห์ได้ ดังนั้นหน้าจอนี้จึงไม่มีสิ่งใดให้เพิ่ม กรุณาแก้ไขในตัวแก้ไขการตั้งค่าก่อน — การบันทึกจากที่นี่จะแทนที่ไฟล์ด้วยรายการนี้เท่านั้น",
      rawDraftPending:
        "คุณมีการเปลี่ยนแปลงที่ยังไม่ได้บันทึกในตัวแก้ไขการกำหนดค่าแบบ raw กรุณาบันทึกหรือยกเลิกก่อน — การลงทะเบียนที่นี่จะเขียนทับฉบับร่างนั้น",
      save: "บันทึก",
      publish: "บันทึกและเผยแพร่",
      publishing: "กำลังเผยแพร่...",
    },
    mcpDraft: {
      title: "ลงทะเบียนเซิร์ฟเวอร์ MCP",
      subtitle:
        "ตั้งชื่อและกำหนด transport หนึ่งรายการ Headers, environment, TLS และ OAuth อยู่ในหน้าจอการตั้งค่า MCP",
      name: "ชื่อ",
      command: "คำสั่ง",
      args: "อาร์กิวเมนต์ (คั่นด้วยช่องว่าง)",
      url: "URL",
      submit: "เพิ่มไปยังการกำหนดค่า",
      nameEmpty: "กรุณาป้อนชื่อเซิร์ฟเวอร์",
      nameTaken: "เซิร์ฟเวอร์ที่มีชื่อนี้ถูกลงทะเบียนแล้ว กรุณาเลือกชื่ออื่น",
      nameUnsupported:
        "ชื่อนี้ไม่สามารถจัดเก็บในตัวแก้ไขการตั้งค่าได้ กรุณาเลือกชื่ออื่น (constructor, prototype และ __proto__ เป็นชื่อสงวน)",
      launchMissing: "กรุณาป้อนคำสั่งหรือ URL เพื่อให้สามารถเปิดใช้งานเซิร์ฟเวอร์ได้",
      urlInvalid:
        "กรุณาป้อน URL ที่เป็น http:// หรือ https:// เท่านั้น MCP over HTTP ไม่สามารถเชื่อมต่อกับโปรโตคอลอื่นได้",
    },
    picker: {
      subtitle: "ค้นหาแคตตาล็อกและเลือกสิ่งที่ขั้นตอนนี้สามารถใช้ได้",
      step: "ขั้นตอน: {nodeId}",
      searchLabel: "ค้นหา",
      noQueryMatches: "ไม่มีผลลัพธ์ที่ตรงกับการค้นหา",
      allAdded: "ทุกรายการในแค็ตตาล็อกนี้ถูกเพิ่มในขั้นตอนนี้แล้ว",
      emptyCatalog: "การ deploy นี้ไม่มีรายการให้เลือก",
      customToolLabel: "หรือป้อนชื่อเครื่องมือ กลุ่ม หรือ glob",
      customNameLabel: "หรือป้อนชื่อ",
      groupOption: "{label} — ทั้งหมวด ({count} เครื่องมือ)",
      confirm: "เพิ่ม {count}",
      close: "ปิด",
      saving: "กำลังบันทึก การปิดกล่องโต้ตอบนี้จะไม่ยกเลิกการดำเนินการ — แผนที่งานจะรีเฟรชเมื่อบันทึกเสร็จสิ้น",
    },
    addNodeSectionTitle: "โครงสร้างเวิร์กโฟลว์",
    addNodeSectionSubtitle:
      "เพิ่มขั้นตอนย่อมภายใต้ขั้นตอนนี้ การดำเนินการนี้จะเปลี่ยนรูปแบบของแผนผังงาน ไม่ใช่สิ่งที่ขั้นตอนนี้สามารถเรียกใช้ได้",
    entryDraft: {
      add: "เพิ่ม",
      removeTitle: "ถอด {entry} ออกจากขั้นตอนนี้",
      none: "ยังไม่มีการประกาศ",
      scopeNarrowingApproval:
        "ขั้นตอนนี้ยังไม่มีรายการเครื่องมือที่อนุญาต จึงอนุญาตเครื่องมือทั้งหมดยกเว้นที่ถูกปฏิเสธ การเพิ่มรายการแรกจะเปลี่ยนเป็นรายการอนุญาต เครื่องมือที่ระบุไว้จะทำงานได้อย่างอิสระ และเครื่องมืออื่น ๆ จะต้องได้รับการอนุมัติเป็นรายครั้ง",
      scopeUngrantedGated:
        "แผนงานนี้กำหนดเครื่องมือที่อนุญาตไว้อย่างชัดเจน จนกว่าเครื่องมือจะถูกระบุไว้ที่นี่หรือในขั้นตอนระดับบน การใช้งานจะต้องขออนุมัติเป็นรายครั้ง — ยกเว้นการตอบกลับและการอ่าน (message, read, memory_search) ซึ่งยังคงใช้งานได้ เว้นแต่ขั้นตอนนั้นจะปฏิเสธหรือนโยบายการกำกับดูแลจะปฏิเสธ",
      knowledgeNarrowing:
        "ขั้นตอนนี้ยังไม่มีรายการอนุญาตความรู้ จึงสามารถสืบค้นทุก Foundation ที่ลงทะเบียนไว้ได้ การเพิ่มรายการแรกจะจำกัดให้เฉพาะ Foundation ที่ระบุไว้เท่านั้น",
      knowledgeUngranted:
        "แผนงานนี้ให้สิทธิ์เข้าถึงความรู้อย่างชัดเจน ขั้นตอนจะไม่สืบค้นฐานความรู้ใดๆ จนกว่าจะมีการระบุไว้ที่นี่หรือในขั้นตอนด้านบน",
      skillNameInvalid: "ใช้ชื่อ Skill: ตัวอักษรพิมพ์เล็ก ตัวเลข และขีดกลางเดี่ยว ไม่เกิน 64 ตัวอักษร",
      foundationIdInvalid: "ใช้ ID ของ Foundation: ส่วนตัวอักษรพิมพ์เล็กคั่นด้วยจุด เช่น acme.runbooks",
      ancestorGateApproval:
        "ขั้นตอนหลัก ({nodeIds}) มีรายการอนุญาตของตนเองสำหรับสิ่งนี้ Governance จะตรวจสอบแต่ละขั้นตอนจากรากขึ้นไป ดังนั้นรายการที่เพิ่มที่นี่จะทำงานโดยไม่ต้องขออนุมัติก็ต่อเมื่อขั้นตอนเหล่านั้นอนุญาตด้วยเท่านั้น มิฉะนั้นจะต้องมีการอนุมัติแบบครั้งเดียว ให้เพิ่มรายการในขั้นตอนเหล่านั้นด้วย หรือใช้ Denied tools เพื่อปฏิเสธโดยตรง",
      ...
      importFailed:
        "การบันทึกไม่ได้รับการยืนยัน อาจมีการบันทึกหรือไม่ก็ได้ — รีเฟรช work-map เพื่อตรวจสอบก่อนลองอีกครั้ง",
      mcpFirstAttachment:
        "แผนงานนี้ยังไม่ได้ควบคุม MCP เมื่อเพิ่มเซิร์ฟเวอร์ตัวแรกที่นี่จะเปิดใช้งานโหมดปฏิเสธโดยค่าเริ่มต้นสำหรับแผนงานทั้งหมด: ทุกขั้นตอนที่ไม่มีสิ่งแนบจะไม่สามารถเข้าถึงเซิร์ฟเวอร์ MCP ใดๆ ได้",
      mcpNoneAttached:
        "ขั้นตอนนี้ไม่มี MCP server แนบอยู่ จึงไม่สามารถเรียกใช้ได้ ต่างจาก tools และ knowledge ตรงที่ MCP ไม่ให้สิทธิ์ใดๆ โดยค่าเริ่มต้น",
      importNotSent:
        "ไม่มีข้อมูลที่ถูกบันทึก: การเชื่อมต่อ Gateway ขาดหายก่อนที่จะส่งข้อมูลนี้ กรุณาเชื่อมต่อใหม่แล้วลองอีกครั้ง",
      importRefused: "เซิร์ฟเวอร์ปฏิเสธการเปลี่ยนแปลงนี้ จึงไม่มีข้อมูลที่ถูกบันทึก: {message}",
      importRejected: "เซิร์ฟเวอร์ปฏิเสธการเปลี่ยนแปลงนี้ จึงไม่มีข้อมูลถูกบันทึก",
      importRejectedDetail: "เซิร์ฟเวอร์ปฏิเสธการเปลี่ยนแปลงนี้ จึงไม่มีข้อมูลถูกบันทึก: {issues}",
    },
    catalogAgentScope:
    ...
    guidanceEditor: {
      title: "พรอมต์บทบาท",
      guidanceNote:
        "อธิบายว่าขั้นตอนนี้มีไว้เพื่ออะไร ด้วยคำพูดของคุณเอง ข้อความนี้จะถูกแสดงในสรุปขั้นตอนเป็นคำแนะนำและไม่ได้ให้สิทธิ์ใดๆ — ขั้นตอนยังคงไม่สามารถเรียกใช้เครื่องมือที่ขอบเขตของมันไม่อนุญาต ไม่ว่าพรอมต์จะเขียนอย่างไรก็ตาม",
      fieldLabel: "Role prompt สำหรับขั้นตอน {nodeId}",
      placeholder: "เช่น ยืนยันตัวตนของผู้เรียกร้องก่อนแจ้งตัวเลขใดๆ",
      save: "บันทึกพรอมต์บทบาท",
      revert: "ย้อนกลับ",
    },
    bindings: {
      title: "Step bindings",
      subtitle: "สิ่งที่ขั้นตอนนี้สามารถเรียกใช้ ความสามารถที่ประกาศ และสิ่งที่สามารถดึงข้อมูลได้",
      tools: "เครื่องมือ — ontology.allowedTools",
      skills: "Skills — ontology.skills",
      knowledge: "ความรู้ — ontology.knowledgeFoundations",
      mcp: "MCP servers — ontology.mcpServers",
      deniedTools: "เครื่องมือที่ถูกปฏิเสธ — ontology.deniedTools",
      deniedToolsWins:
        "การปฏิเสธจะมีผลเหนือกว่าเสมอ โดยจะมีผลกับขั้นตอนนี้และทุกอย่างภายใต้ขั้นตอนนี้ และไม่มีการให้สิทธิ์ใดในสาขาย่อยที่จะเพิกถอนได้",
      deniedToolsNotEnforcing:
        "การปฏิเสธถูกบันทึกไว้แต่ไม่ถูกนำไปใช้ในขณะที่ enterprise mediation ไม่ได้บังคับใช้ เมื่อเริ่มบังคับใช้แล้ว การปฏิเสธจะมีผลกับขั้นตอนนี้และทุกสิ่งที่อยู่ภายใต้ขั้นตอนนี้ และไม่มีการอนุญาตใดในสาขาที่ต่ำกว่าจะสามารถยกเลิกได้",
      deniedElsewhere: "ถูกปฏิเสธโดยสาขาอื่นของ work-map นี้ด้วย:",
      skillNotInstalled: "ยังไม่ได้ติดตั้ง",
      foundationNotRegistered: "ยังไม่ได้ลงทะเบียน",
      mcpNotRegistered: "ไม่ได้ลงทะเบียนใน mcp.servers",
      inherited: "สืบทอดมาจากขั้นตอนหลัก:",
    },
    skillsTab: {
      title: "Skills",
      subtitle: "Skills ทั้งหมดที่ติดตั้งสำหรับ Gateway นี้ พร้อมเงื่อนไขที่ต้องมีเพื่อให้ใช้งานได้",
      attachHint:
      ...
      attachHintGranted:
        "Work-map นี้กำหนด Skills อย่างชัดเจน: การรันที่ผูกกับ work-map จะได้รับเฉพาะ Skills ที่ขั้นตอนต่างๆ ประกาศไว้เท่านั้น และ Skills อื่นๆ ทั้งหมดที่ติดตั้งไว้จะถูกซ่อนจากโมเดล",
    ...
    capabilityGrants: {
      explicit: "การให้สิทธิ์โดยตรง",
      inherited: "ขอบเขตที่สืบทอด",
      explicitHintGated:
        "แต่ละขั้นตอนควรใช้เครื่องมือ, Skills, MCP servers และ knowledge foundations ที่ระบุไว้ในขั้นตอนนั้นหรือขั้นตอนระดับบน Skills, MCP servers และ knowledge foundations ที่ไม่ได้ระบุไว้ในขั้นตอนจะถูกระงับโดยสิ้นเชิง เครื่องมือที่ไม่ได้ระบุไว้จะต้องขออนุมัติเป็นรายครั้งแทน และการตอบกลับและการอ่าน (message, read, memory_search) ยังคงใช้งานได้ เว้นแต่ขั้นตอนหรือนโยบายการกำกับดูแลจะปฏิเสธ",
      explicitHintNotEnforcing:
        "แผนงานนี้ให้สิทธิ์ความสามารถอย่างชัดแจ้ง แต่โหมดองค์กรไม่ได้บังคับใช้ การให้สิทธิ์เครื่องมือ, Skills และ MCP จะถูกบันทึกไว้แต่ไม่ได้นำไปใช้งาน การให้สิทธิ์ความรู้ยังคงจำกัดขอบเขตการเรียกค้นในทุกโหมด",
      explicitHintOff:
        "แผนผังงานนี้มอบความสามารถอย่างชัดเจน แต่การไกล่เกลี่ยระดับองค์กรไม่ได้เปิดใช้งานอยู่ จึงไม่มีการมอบสิทธิ์ใดมีผลบังคับใช้ การมอบสิทธิ์ด้านล่างจะถูกบันทึกไว้และมีผลเมื่อเปิดใช้งานการไกล่เกลี่ย",
      inheritedHint:
        "รายการของแต่ละขั้นตอนจะจำกัดขอบเขตจากสิ่งที่ขั้นตอนระดับบนอนุญาตไว้ หากขั้นตอนย่อยไม่ได้ระบุรายการไว้ จะสามารถใช้เครื่องมือหรือ Skills ใดก็ได้",
      turnOn: "ให้สิทธิ์อย่างชัดเจน",
      turnOff: "ใช้ขอบเขตที่สืบทอดมา",
    },
  ...
  subtitles: {
    ...
    enterpriseTools: "แค็ตตาล็อกเครื่องมือที่กำหนดค่าไว้",
    enterpriseSkills: "Skills ทั้งหมดที่ติดตั้งสำหรับ Gateway นี้",
    enterpriseMcp: "MCP servers ที่ลงทะเบียนไว้และขั้นตอนที่สามารถเรียกใช้ได้",
