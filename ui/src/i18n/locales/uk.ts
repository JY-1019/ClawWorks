...
export const uk: TranslationMap = {
  ...
  enterprise: {
    ...
    toolsTab: {
      title: "Інструменти",
      subtitle:
        "Налаштований каталог інструментів, згрупований так, як їх групує середовище виконання. Інструмент плагіна відображається одразу після оголошення, навіть до завершення розпізнавання його конфігурації, а інструменти каналів і MCP існують лише в активній сесії, тому тут показано те, що можна налаштувати, а не те, що зараз активне.",
      attachHint:
        "Це каталог. Щоб дозволити кроку викликати інструмент, відкрийте Worktree, виберіть крок і додайте його в розділі «Прив'язки кроку».",
      attachHintGrantedGated:
        "Ця робоча карта надає інструменти явно. Крок має використовувати інструменти, які він перелічує, або ті, що перелічені на кроці вище. Будь-який інший інструмент ініціює одноразове підтвердження замість виконання і буде відхилено, якщо ніхто не відповість. Відповіді та читання (message, read, memory_search) залишаються доступними на кожному кроці, якщо крок їх не забороняє або це не робить політика управління.",
      empty: "На цьому Gateway немає доступних інструментів.",
      toolCount: "{count} інструмент(ів)",
      optionalBadge: "необов'язковий",
      pluginBadge: "Плагін: {pluginId}",
    },
    mcpTab: {
      title: "MCP",
      subtitle:
        "MCP-сервери, зареєстровані для цього gateway. Реєстрація тут аналогічна будь-якому іншому місцю в OpenClaw — сервер потрапляє в mcp.servers — але в корпоративному режимі він залишається недоступним, поки крок не підключить його.",
      attachHint:
        "Щоб крок міг викликати сервер, відкрийте Worktree, виберіть крок і додайте його в Step bindings. Сервер, до якого не підключено жодного кроку, є зареєстрованим, але недоступним.",
      nativeConfigBoundary:
        "Це визначає сервери, які OpenClaw передає для виконання. Сервер, оголошений безпосередньо в конфігурації середовища виконання, наприклад у файлі конфігурації Codex, залишається поза цим — цей рівень належить середовищу виконання, а не Gateway.",
      attachHintUngoverned:
        "Ця робоча карта ще не керує MCP, тому зареєстровані сервери залишаються доступними як звичайні інструменти. Прикріплення сервера до кроку в розділі «Step bindings» вмикає режим заборони за замовчуванням для всієї робочої карти.",
      empty: "Для цього Gateway не зареєстровано жодного сервера MCP.",
      add: "Зареєструвати сервер",
      disabled: "вимкнено",
      unattached: "не прикріплено до жодного кроку",
      unsaved:
        "Ця реєстрація зберігається лише у вашому браузері, доки ви не збережете її в конфігурацію.",
      waitingForConfig:
        "Завантаження конфігурації Gateway; реєстрація буде доступна після її отримання.",
      configSaving:
        "Конфігурація зараз зберігається. Зачекайте завершення — сервер, зареєстрований зараз, буде відкинутий після перезавантаження збереженої конфігурації.",
      configInvalid:
        "Конфігурація Gateway не може бути розібрана, тому цьому екрану нічого додати. Спочатку виправте її в редакторі конфігурації — збереження звідси замінить файл лише цим записом.",
      rawDraftPending:
        "У редакторі необробленої конфігурації є незбережені зміни. Спочатку збережіть або скасуйте їх — реєстрація тут перезапише цей чернетку.",
      save: "Зберегти",
      publish: "Зберегти й опублікувати",
      publishing: "Публікація...",
    },
    mcpDraft: {
      title: "Зареєструвати сервер MCP",
      subtitle:
        "Назвіть його та вкажіть один транспорт. Заголовки, змінні середовища, TLS та OAuth налаштовуються на екрані налаштувань MCP.",
      name: "Назва",
      command: "Команда",
      args: "Аргументи (через пробіл)",
      url: "URL",
      submit: "Додати до конфігурації",
      nameEmpty: "Введіть назву сервера.",
      nameTaken: "Сервер із такою назвою вже зареєстровано; виберіть іншу назву.",
      nameUnsupported:
        "Це ім'я не може бути збережене в редакторі конфігурації. Виберіть інше (constructor, prototype та __proto__ є зарезервованими).",
      launchMissing: "Введіть команду або URL, щоб сервер можна було запустити.",
      urlInvalid:
        "Введіть URL http:// або https://; MCP over HTTP не може підключатися до інших адрес.",
    },
    picker: {
      subtitle: "Шукайте в каталозі та обирайте, що може використовувати цей крок.",
      step: "Крок: {nodeId}",
      searchLabel: "Пошук",
      noQueryMatches: "Нічого не знайдено за цим запитом.",
      allAdded: "Усе з цього каталогу вже додано до цього кроку.",
      emptyCatalog: "Це розгортання не має жодного варіанту.",
      customToolLabel: "Або введіть назву інструмента, групу чи glob",
      customNameLabel: "Або введіть назву",
      groupOption: "{label} — весь розділ ({count} інструментів)",
      confirm: "Додати {count}",
      close: "Закрити",
      saving:
        "Збереження. Закриття цього діалогу не скасує його — робоча карта оновиться, коли зміни будуть застосовані.",
    },
    addNodeSectionTitle: "Структура робочого процесу",
    addNodeSectionSubtitle:
      "Додайте підкрок під цим. Це змінює структуру робочої карти, а не те, що може викликати цей крок.",
    entryDraft: {
      add: "Додати",
      removeTitle: "Від'єднати {entry} від цього кроку",
      none: "Ще нічого не оголошено.",
      scopeNarrowingApproval:
        "Цей крок ще не має списку дозволених інструментів, тому він дозволяє всі інструменти, крім заборонених. Додавання першого запису перетворює його на список дозволених. Перелічені інструменти працюють вільно, а для всіх інших потрібне одноразове схвалення.",
      scopeUngrantedGated:
        "Ця робоча карта надає інструменти явно. Доки інструмент не зазначено тут або на кроці вище, його використання потребує одноразового підтвердження — за винятком відповідей та читання (message, read, memory_search), які залишаються доступними, якщо крок їх не забороняє або це не робить політика управління.",
      knowledgeNarrowing:
        "Цей крок ще не має списку дозволених джерел знань, тому він може запитувати кожну зареєстровану основу. Додавання першого запису обмежує його переліченими основами.",
      knowledgeUngranted:
        "Ця робоча карта надає знання явно. Крок не запитує жодну базу знань, доки вона не буде вказана тут або на кроці вище.",
      skillNameInvalid:
        "Використовуйте назву навички: малі літери, цифри та одинарні дефіси, не більше 64 символів.",
      foundationIdInvalid:
        "Використовуйте ідентифікатор основи: сегменти в нижньому регістрі, розділені крапками, наприклад acme.runbooks.",
      ancestorGateApproval:
        "Батьківські кроки ({nodeIds}) мають власний список дозволів для цього. Governance перевіряє кожен крок від кореня, тому запис, доданий тут, виконується без запиту лише якщо ті кроки також його дозволяють; інакше потрібне одноразове підтвердження. Додайте його також до тих кроків або використовуйте Denied tools, щоб відхилити його повністю.",
      empty: "Спочатку введіть значення.",
      duplicate: "Цей запис уже оголошено для цього кроку.",
      nodeMissing: "Цього кроку більше немає в дереві; перезавантажте та спробуйте знову.",
      exportFailed: "Не вдалося завантажити визначення дерева для редагування.",
      importFailed:
        "Збереження не підтверджено. Воно могло бути застосоване або ні — оновіть робочу карту, щоб перевірити, перш ніж спробувати знову.",
      mcpFirstAttachment:
        "Ця робоча карта ще не керує MCP. Додавання першого сервера тут увімкне режим заборони за замовчуванням для ВСІЄЇ робочої карти: кожен крок без вкладення тоді не матиме доступу до жодного MCP-сервера.",
      mcpNoneAttached:
        "До цього кроку не підключено жодного MCP-сервера, тому він не може викликати жодного. На відміну від інструментів і знань, MCP не надає нічого за замовчуванням.",
      importNotSent:
        "Нічого не збережено: з'єднання з Gateway було розірвано до надсилання. Підключіться знову та спробуйте ще раз.",
      importRefused: "Сервер відхилив цю зміну, тому нічого не збережено: {message}",
      importRejected: "Сервер відхилив цю зміну, тому нічого не було збережено.",
      importRejectedDetail: "Сервер відхилив цю зміну, тому нічого не було збережено: {issues}",
    },
    catalogAgentScope:
      "Інструменти та навички прив'язані до агента; цей каталог бачить агент {agentId}.",
    catalogUsage: {
      scope: "Використання кроків нижче вимірюється відносно вибраної робочої карти, {treeName}.",
      noWorkMap:
        "Робочу карту не вибрано, тому використання кроків не відображається. Виберіть карту у Worktree, щоб побачити, які кроки використовують кожен запис.",
      usedBy: "Використовується {treeName}:",
      declaredBy: "Оголошено {treeName}:",
      attachedTo: "Підключено до {treeName}:",
      treeIssue:
        "Обрана робоча карта не завантажилася, тому наведені нижче кроки отримані з резервного визначення, яке повернув Gateway: {message}. У режимі примусового виконання невдала робоча карта нічим не керує, доки не завантажиться.",
      treeUnavailable:
        "Не вдалося завантажити обрану робочу карту, тому використання кроків не відображається: {message}.",
    },
    guidanceEditor: {
      title: "Промпт ролі",
      guidanceNote:
        "Для чого призначений цей крок, вашими словами. Це відображається в дайджесті кроку як інструкція і нічого не надає — крок все одно не може викликати інструмент, який його область дії приховує, незалежно від формулювання промпту.",
      fieldLabel: "Рольовий промпт для кроку {nodeId}",
      placeholder: "напр. Підтвердіть особу заявника перед тим, як називати будь-які суми.",
      save: "Зберегти промпт ролі",
      revert: "Скасувати зміни",
    },
    bindings: {
      title: "Прив'язки кроку",
      subtitle:
        "Що цей крок може викликати, компетенції, які він оголошує, та що він може отримувати.",
      tools: "Інструменти — ontology.allowedTools",
      skills: "Skills — ontology.skills",
      knowledge: "Знання — ontology.knowledgeFoundations",
      mcp: "MCP-сервери — ontology.mcpServers",
      deniedTools: "Заборонені інструменти — ontology.deniedTools",
      deniedToolsWins:
        "Заборона завжди має пріоритет. Вона застосовується до цього кроку та всього під ним, і жоден дозвіл нижче по гілці не може її скасувати.",
      deniedToolsNotEnforcing:
        "Відмови записуються, але не застосовуються, поки корпоративне посередництво не є примусовим. Коли воно стане примусовим, відмова застосовуватиметься до цього кроку та всього, що під ним, і жодний дозвіл нижче по гілці не зможе її скасувати.",
      deniedElsewhere: "Також відхилено іншою гілкою цієї робочої карти:",
      skillNotInstalled: "не встановлено",
      foundationNotRegistered: "не зареєстровано",
      mcpNotRegistered: "не зареєстровано в mcp.servers",
      inherited: "Успадковано з батьківського кроку:",
    },
    skillsTab: {
      title: "Skills",
      subtitle:
        "Усі Skills, встановлені для цього Gateway, із зазначенням умов їхньої відповідності.",
      attachHint:
        "Це каталог. Щоб оголосити залежність кроку, відкрийте Worktree, виберіть крок і додайте її в розділі «Прив'язки кроку».",
      attachHintGranted:
        "Ця робоча карта надає Skills явно: запуск, прив'язаний до неї, отримує лише ті Skills, які оголошені в його кроках, а всі інші встановлені Skills приховуються від моделі.",
      empty: "Skills не встановлено.",
    ...
    capabilityGrants: {
      explicit: "Явні дозволи",
      inherited: "Успадковані області",
      explicitHintGated:
        "Кожен крок має використовувати інструменти, Skills, сервери MCP та бази знань, зазначені на ньому або на кроці вище. Skills, сервери MCP та бази знань, не зазначені на кроці, повністю недоступні. Незазначений інструмент натомість ініціює одноразове підтвердження, а відповіді та читання (message, read, memory_search) залишаються доступними, якщо крок або політика управління їх не забороняє.",
      explicitHintNotEnforcing:
        "Ця робоча карта надає можливості явно, але режим enterprise не застосовує обмеження. Надання доступу до інструментів, Skills та MCP фіксується, але не застосовується. Надання доступу до знань обмежує пошук у будь-якому режимі.",
      explicitHintOff:
        "Ця робоча карта надає можливості явно, але корпоративне посередництво не активне, тому жодне надання не застосовується. Наведені нижче надання збережені та набудуть чинності після увімкнення посередництва.",
      inheritedHint:
        "Списки кроку звужують те, що дозволили його предки; крок, гілка якого не містить нічого, може використовувати будь-який інструмент або навичку.",
      turnOn: "Надати явно",
      turnOff: "Використовувати успадковані області",
    },
  ...
  tabs: {
    ...
    logs: "Журнали",
    dreams: "Сни",
    enterpriseWorktree: "Робоче дерево",
    enterpriseHistory: "Історія",
    enterpriseTools: "Інструменти",
  ...
  subtitles: {
    ...
    enterpriseWorktree: "Дерева робочих процесів та їхні керовані кроки.",
    enterpriseHistory: "Минулі керовані запуски та їхні трасування.",
    enterpriseTools: "Налаштований каталог інструментів.",
    enterpriseSkills: "Усі Skills, встановлені для цього Gateway.",
    enterpriseMcp: "Зареєстровані MCP-сервери та кроки, які можуть їх викликати.",
