...
export const uk: TranslationMap = {
  ...
  enterprise: {
    ...
    toolsTab: {
      ...
      grantTitle: "Надати інструмент кроку",
      grantSubtitle:
        "Додайте назву інструмента або групу до ontology.allowedTools вибраного кроку. Заборона завжди має пріоритет.",
    },
    entryDraft: {
      add: "Додати",
      forStep: "Крок: {nodeId}",
      none: "Ще нічого не оголошено.",
      selectStep: "Спочатку виберіть крок на вкладці Worktree.",
      stepUnavailable:
        "Обраний крок не завантажено. Оновіть сторінку або виберіть його повторно на вкладці Worktree.",
      editorOpen:
        "Збережіть або скасуйте відкритий редактор дерева перед додаванням іншого запису.",
      scopeNarrowing:
      ...
      ancestorGate:
        "Батьківські кроки ({nodeIds}) мають власний список дозволених інструментів. Governance перевіряє кожен крок від кореня, тому інструмент, наданий тут, все одно буде відхилено, якщо ті кроки також його не дозволяють.",
  ...
  subtitles: {
    ...
    enterpriseTools: "Інструменти, які надають корпоративні групи.",
    enterpriseSkills: "Skills, які оголошують кроки робочого процесу.",
