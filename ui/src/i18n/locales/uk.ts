...
export const uk: TranslationMap = {
  ...
  enterprise: {
    ...
    entryDraft: {
      ...
      toolLabel: "Назва інструмента або групи для дозволу",
      skillLabel: "Назва навички для оголошення",
      knowledgeLabel: "Ідентифікатор основи знань для дозволу",
      skillNameInvalid:
      ...
      reviewHint: "Додавання відкриє редактор дерева, щоб ви могли переглянути та зберегти зміну.",
