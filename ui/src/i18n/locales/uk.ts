...
export const uk: TranslationMap = {
  ...
  enterprise: {
    ...
    toolsTab: {
      ...
      attachHintGranted:
        "Ця робоча карта надає інструменти явно. Крок може викликати лише ті інструменти, які він перелічує, або ті, що перелічені у кроці вищого рівня. Усі інші інструменти в цьому каталозі заборонені.",
    ...
    entryDraft: {
      ...
      scopeNarrowing:
        "Цей крок ще не має списку дозволених інструментів, тому він дозволяє всі інструменти, крім заборонених. Додавання першого запису перетворює його на список дозволених, і лише перелічені інструменти залишаться доступними.",
      scopeUngranted:
        "Ця робоча карта надає інструменти явно. Крок не матиме доступу до жодного інструменту, доки він не буде вказаний тут або на кроці вище.",
      knowledgeNarrowing:
      ...
      ancestorGate:
        "Батьківські кроки ({nodeIds}) мають власний список дозволів для цього. Governance перевіряє кожен крок від кореня, тому запис, доданий тут, все одно буде відхилено, якщо ті кроки його не дозволяють.",
    ...
    capabilityGrants: {
      ...
      explicitHint:
        "Кожен крок має доступ лише до інструментів, Skills, серверів MCP та баз знань, які вказані в ньому або в кроці вище. Крок, у якому нічого не вказано, не має доступу ні до чого.",
      inheritedHint:
