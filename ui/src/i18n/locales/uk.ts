...
export const uk: TranslationMap = {
  ...
  enterprise: {
    ...
    capabilityGrants: {
      ...
      explicitHint:
        "Кожен крок має доступ лише до інструментів, Skills та MCP-серверів, які вказані в ньому або в кроці вище. Крок, у якому нічого не вказано, не має доступу ні до чого.",
      inheritedHint:
