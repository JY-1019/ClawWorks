...
export const fa: TranslationMap = {
  ...
  enterprise: {
    ...
    capabilityGrants: {
      ...
      explicitHint:
        "هر مرحله فقط به ابزارها، Skills و سرورهای MCP که خودش یا مرحله‌ای بالاتر از آن فهرست کرده دسترسی دارد. مرحله‌ای که هیچ‌کدام را فهرست نکرده باشد، به هیچ‌کدام دسترسی ندارد.",
      inheritedHint:
