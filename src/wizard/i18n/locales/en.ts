...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in ClawWorks config",
    ...
    remote: {
      ...
      plaintextPasswordHint: "Stores the password directly in ClawWorks config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in ClawWorks config",
    ...
    security: {
      ...
      beta: "ClawWorks is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run ClawWorks.",
      learnMore: "Learn more",
      notMultitenant: "ClawWorks is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, ClawWorks is a personal agent: one trusted operator boundary.",
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so ClawWorks can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for ClawWorks",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL ClawWorks uses to send replies back to Chat.",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to ClawWorks with full agent capabilities.",
    ...
    finalize: {
      ...
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control ClawWorks.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control ClawWorks.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control ClawWorks.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control ClawWorks.",
      outroSeeded:
