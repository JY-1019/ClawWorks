    ...
    lines.push(
      ...
      ...(acpEnabled
        ? [
            ...
            '`agents_list` and `subagents` apply to ClawWorks sub-agents (`runtime: "subagent"`); ACP harness ids are controlled by `acp.allowedAgents`.',
            ...
            'Use `subagents` only for ClawWorks subagents (`runtime: "subagent"`).',
