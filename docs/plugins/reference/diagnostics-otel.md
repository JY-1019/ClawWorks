---
summary: "ClawWorks diagnostics OpenTelemetry exporter for metrics, traces, and logs."
read_when:
...
ClawWorks diagnostics OpenTelemetry exporter for metrics, traces, and logs.
