---
summary: "ClawWorks Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing."
read_when:
...
ClawWorks Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing.
