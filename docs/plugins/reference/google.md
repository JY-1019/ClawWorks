---
summary: "Adds Google, Google Gemini CLI, Google Vertex model provider support to ClawWorks."
read_when:
...
Adds Google, Google Gemini CLI, Google Vertex model provider support to ClawWorks.
