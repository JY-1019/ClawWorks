---
summary: "ClawWorks Amazon Bedrock provider plugin with model discovery, embeddings, and guardrail support."
read_when:
...
ClawWorks Amazon Bedrock provider plugin with model discovery, embeddings, and guardrail support.
