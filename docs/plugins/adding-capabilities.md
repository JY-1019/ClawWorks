---
summary: "Contributor guide for adding a new shared capability to the ClawWorks plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for ClawWorks core developers. If you are
...
Use this when ClawWorks needs a new shared domain such as embeddings, image
