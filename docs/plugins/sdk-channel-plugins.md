---
summary: "Step-by-step guide to building a messaging channel plugin for ClawWorks"
title: "Building channel plugins"
sidebarTitle: "Channel Plugins"
read_when:
  - You are building a new messaging channel plugin
  - You want to connect ClawWorks to a messaging platform
  - You need to understand the ChannelPlugin adapter surface
---

This guide walks through building a channel plugin that connects ClawWorks to a
...
Channel plugins do not need their own send/edit/react tools. ClawWorks keeps one
...
<Steps>
    ...
    ```json package.json
    {
      ...
      "openclaw": {
        ...
        "channel": {
          "id": "acme-chat",
          "label": "Acme Chat",
          "blurb": "Connect ClawWorks to Acme Chat."
        }
      }
    }
    ```
  ...
  <Step title="Wire the entry point">
    ...
    Put channel-owned CLI descriptors in `registerCliMetadata(...)` so ClawWorks
  ...
  <Step title="Add a setup entry">
    ...
    ClawWorks loads this instead of the full entry when the channel is disabled
  ...
  <Step title="Handle inbound messages">
    ...
    ClawWorks. The typical pattern is a webhook that verifies the request and
    ...
    registerFull(api) {
      api.registerHttpRoute({
        ...
        handler: async (req, res) => {
          ...
          // Your inbound handler dispatches the message to ClawWorks.
