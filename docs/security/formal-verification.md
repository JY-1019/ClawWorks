---
summary: Machine-checked security models for ClawWorks's highest-risk paths.
...
This page tracks ClawWorks's **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that ClawWorks enforces its
...
**What this is not (yet):** a proof that "ClawWorks is secure in all respects" or that the full TypeScript implementation is correct.
