...
ClawWorks includes syntax highlighting for common source, config, and documentation languages:
...
<Steps>
  <Step title="Config">
    `browser.executablePath` in ClawWorks config.
  </Step>
