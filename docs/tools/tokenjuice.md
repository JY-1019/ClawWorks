...
title: "Tokenjuice"
read_when:
  - You want shorter `exec` or `bash` tool results in ClawWorks
...
Today this applies to ClawWorks embedded runs and ClawWorks dynamic tools in the Codex
app-server harness. Tokenjuice hooks ClawWorks's tool-result middleware and
