...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install ClawWorks and bring up the Gateway in minutes.
  </Card>
...
<p align="center">
  <img src="/whatsapp-openclaw.jpg" alt="ClawWorks" width="420" />
</p>
...
- If you **do nothing**, ClawWorks uses the bundled ClawWorks agent runtime with per-sender sessions.
