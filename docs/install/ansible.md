---
summary: "Automated, hardened ClawWorks installation with Ansible, Tailscale VPN, and firewall isolation"
read_when:
...
Deploy ClawWorks to production servers with **[openclaw-ansible](https://github.com/openclaw/openclaw-ansible)** -- an automated installer with security-first architecture.
...
5. **ClawWorks** -- host-based, not containerized
...
<Steps>
  ...
  <Step title="Run the onboarding wizard">
    The post-install script guides you through configuring ClawWorks settings.
  </Step>
...
The Ansible installer sets up ClawWorks for manual updates. See [Updating](/install/updating) for the standard update flow.
