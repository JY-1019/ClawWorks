---
summary: "ClawDock shell helpers for Docker-based ClawWorks installs"
read_when:
  - You run ClawWorks with Docker often and want shorter day-to-day commands
  - You want a helper layer for dashboard, logs, token setup, and pairing flows
title: "ClawDock"
---

ClawDock is a small shell-helper layer for Docker-based ClawWorks installs.
...
| `clawdock-cli <command>`  | Run ClawWorks CLI commands in Docker          |
...
| `clawdock-cd`          | Jump to the ClawWorks project directory |
...
<CardGroup cols={2}>
  <Card title="Docker" href="/install/docker" icon="docker">
    Canonical Docker install for ClawWorks.
  </Card>
  ...
  <Card title="Updating" href="/install/updating" icon="arrow-up-right-from-square">
    Updating the ClawWorks package and managed services.
  </Card>
</CardGroup>
