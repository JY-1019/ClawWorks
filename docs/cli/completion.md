...
read_when:
  ...
  - You need to cache completion scripts under ClawWorks state
title: "Completion"
---
...
- `--install` writes a small "ClawWorks Completion" block into your shell profile and points it at the cached script.
