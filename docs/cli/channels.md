...
If a channel plugin needs to be installed during a flag-driven add command, ClawWorks uses the channel's default install source without opening the interactive plugin install prompt.
