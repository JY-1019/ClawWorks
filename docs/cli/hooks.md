...
those to a prerelease, ClawWorks stops and asks you to opt in explicitly with a
...
ClawWorks prints a warning and asks for confirmation before proceeding. Use
