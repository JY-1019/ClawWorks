---
summary: "First-run setup flow for ClawWorks (macOS app)"
read_when:
...
- By default, ClawWorks is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give ClawWorks">
