...
Dreaming is the background memory consolidation system in `memory-core`. It helps ClawWorks move strong short-term signals into durable memory while keeping the process explainable and reviewable.
