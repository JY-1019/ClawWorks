...
ClawWorks also builds a separate idempotent replay view for sessions that
...
ClawWorks auto-enables pruning for Anthropic profiles:
...
If you set explicit values, ClawWorks does not override them.
