...
export const discordChannelConfigUiHints = {
  ...
  "streaming.progress.labels": {
    ...
    help: 'Candidate labels for streaming.progress.label="auto". Leave unset to use ClawWorks built-in progress labels.',
  },
  ...
  "eventQueue.listenerTimeout": {
    ...
    help: "Canonical Discord listener timeout control in ms for gateway normalization/enqueue handlers. Default is 120000 in ClawWorks; set per account via channels.discord.accounts.<id>.eventQueue.listenerTimeout.",
  },
  ...
  "voice.mode": {
    ...
    help: "Conversation mode: agent-proxy (default) uses realtime voice as the microphone/speaker for the routed ClawWorks agent, stt-tts uses batch speech-to-text plus TTS, and bidi lets the realtime provider converse directly with the ClawWorks consult tool.",
  },
  "voice.agentSession": {
    label: "Discord Voice Agent Session",
    help: 'Controls which ClawWorks conversation receives voice turns. Leave unset for the voice channel session, or set mode="target" with a Discord target such as channel:123 to make voice an extension of an existing text channel session.',
  },
  ...
  "voice.realtime.model": {
    ...
    help: "Provider realtime session model, such as gpt-realtime-2. This is separate from voice.model, which remains the ClawWorks agent brain model.",
  },
  ...
  "voice.realtime.toolPolicy": {
    ...
    help: "Tool policy for the ClawWorks agent consult tool in realtime voice modes: safe-read-only, owner, or none. Default is owner for agent-proxy and safe-read-only for bidi.",
  },
  "voice.realtime.consultPolicy": {
    label: "Discord Realtime Consult Policy",
    help: "Use always to strongly prefer the ClawWorks agent brain for substantive realtime turns. agent-proxy defaults to always.",
  },
  ...
  "voice.reconnectGraceMs": {
    ...
    help: "Grace period for a disconnected Discord voice session to enter Signalling or Connecting before ClawWorks destroys it. Default: 15000.",
  },
  "voice.captureSilenceGraceMs": {
    label: "Discord Voice Capture Silence Grace (ms)",
    help: "Silence window after Discord reports a speaker ended before ClawWorks finalizes the audio segment for transcription. Default: 2000.",
  },
  "voice.tts": {
