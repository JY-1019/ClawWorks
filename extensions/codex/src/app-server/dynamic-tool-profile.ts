...
/** Tool names owned by Codex app-server and normally excluded from ClawWorks dynamic tools. */
...
/** Normalizes ClawWorks/Codex tool names before filtering and allowlist checks. */
