...
// Filtering them out of the ClawWorks bootstrap injection avoids
...
/**
 * Loads ClawWorks workspace bootstrap files (IDENTITY.md, SOUL.md,
...
export function renderCopilotWorkspaceBootstrapInstructions(
  ...
  const lines: string[] = [
    "ClawWorks loaded these user-editable workspace files. Treat them as project/user context. The Copilot SDK loads AGENTS.md natively from its instruction directories, so AGENTS.md is not repeated here.",
    "",
    "# Project Context",
    "",
