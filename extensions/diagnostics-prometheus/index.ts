// Diagnostics Prometheus plugin entrypoint registers its ClawWorks integration.
...
export default definePluginEntry({
  ...
  description: "Expose ClawWorks diagnostics metrics in Prometheus text format",
  register(api) {
